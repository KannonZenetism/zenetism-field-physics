...
Across the originator's primary publication platforms, access patterns are materially inconsistent with ordinary organic readership: high automated retrieval and download activity alongside near-absent human-visible browsing and public relation. The pattern establishes a **channel condition** — the corpus is retrieved, cloned, downloaded, and indexed at volumes and in ratios characteristic of automated ingestion, while public-facing engagement remains near zero.

The records establish that a documented ingestion channel exists: a route through which Zenetist language, structure, and register can be carried into downstream systems — including model-training pipelines — without attribution and without accountable relation.
...
|:--|:--|:--|:--|
| GitHub — `zenetism-field-physics` | 9,933 clones / 2,576 unique cloners / 2,041 views / **1 unique visitor**, 14-day window (May 6, 2026) | Very high automated retrieval relative to negligible human-visible browsing | Strongest single anomaly; consistent with mirroring, indexing, scripted access, or training-pipeline ingestion |
