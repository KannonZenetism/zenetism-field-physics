...
This section does **not** conclude that such a protocol has been located. It does **not** conclude that K. Michael Wiley / "grail seeker" distributed it. It does **not** conclude that any particular AI training pipeline carried the author's work into the scene. Those remain hypotheses pending artifact recovery.
