...
- **Author classification** — what the author assesses, on a stated perceptual basis
- **Platform disclosure** — what the surface or platform states about itself
- **External technical verification** — what independent synthetic-media analysis establishes
...
Public indexing surfaces the same video on:

- Hermetic Talk
- Daniel Moreno — `@danielmorenoyt`
- Library of Thoth — `@LibraryofThoth`
...
- motion-specific presentation characteristics substantially clearer in video than in any single frame
...
- **"I Tested…"** — experimental labor: the speaker as the party who performed the practice
- **"…With Physical Eyes…"** — embodied sensory provenance: an explicit invocation of a biological sensory apparatus
- **"…for 30 Nights…"** — longitudinal lived duration: sustained participation across repeated nights
- **"Night 19 Broke Me"** — event-specific autobiographical provenance: a particular episode, indexed to a particular night, producing a stated psychological consequence
