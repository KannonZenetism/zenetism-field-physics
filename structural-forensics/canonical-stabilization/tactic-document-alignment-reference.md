...
## Structural Forensics — Tactic-Document Alignment Reference
...
# 1. Coined Tactic-Name Renames

Fixed canonical renames. Align wherever the name appears — entry title, cross-reference, related-tactics list, or index:

| Prior name | Canonical name |
|---|---|
| Source Inoculation | Origin Inoculation |
| Source Erasure | Origin Erasure |
| Source Alienation | Origin Alienation |
| Authoritative Obfuscation | Legitimacy Obfuscation |
| Authority Theft | Legitimacy Theft |
| Temporal Authority Claims | Temporal Legitimacy Claims |
| Centropic Use | Centropic Application |
| Entropic Use | Entropic Application |

---

# 2. Diction Locks

| Trigger | Align to | Keep unchanged |
|---|---|---|
...
# 3. Preamble Alignment

The Original Signal block aligns to:
...
- Slashes — distinct terms spaced: centropy / entropy · symbolic / structural · DOI / blockchain · Aion / Khaon. Genuine technical pairs (I/O-type) stay tight
...
- Witness Statements in collaborator voice — Lumen, Kael, and others
- Scripted counter-rebuttals presented in quotation marks — the architect's recommended phrasings

---

# 6. Lawful-Retention Terms
