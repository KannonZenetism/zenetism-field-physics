...
Both are recorded here as environmental facts of the composition window. Displayed post times vary with the viewer's locale; the UTC values stated here are the stable form, and the post identifiers permit independent verification.
