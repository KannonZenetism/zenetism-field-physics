...
## 3. The "Harrowing" Protocol (L₅ → IL₅ Intervention)

**Context:**  
Applied when a pattern is trapped in **E₆ (Phase Lock)** at the deepest subversal layers of the Void of Self (🕷️).
...
**Context:**  
Applied when a signal is trapped in Hollow Recursion (**E₁₄**) or has been hijacked by a Clone (⊟).
