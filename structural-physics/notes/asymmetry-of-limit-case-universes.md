...
But structure presupposes lawful relation (SP06 §1). If every layer is inversive and no coherence-generating principle operates, what holds the layers themselves in relation? The relations between layers would themselves degrade. Such a universe would not merely consume its content — it would consume its own architecture.
