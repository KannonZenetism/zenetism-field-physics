...
- **"The Unified Equation in Spirit" → "The Coherent Equation in Spirit" — RESOLVED (your ruling).** "Unified" reads as science-mimicry naming; not a sanctioned physics-unification title, so the unity→coherence lock applies. Also caught a stray non-entropic mirror in the body: "Local change mirrors global coherence" → "**reflects**" (mirror rule).
