...
Gathered from the seven Lattice Mathematics volumes per §6.4. Lattice Mathematics carries no glyph chart of its own; its first-pass index is the Notation Quick Reference of the series `README.md` and the notation appendices of LM03–LM07, and gathering runs from the volumes. Standing is assigned per §5 before any descriptor. Most of the module stands **formal**: the operator's prose expansion is its analytic form, and a reader meets the expansion before the notation, per §9.1. This is an initial seating for the terms a reader meets in Lattice Mathematics publications and in the formal passages of Structural Physics and Structural Neuroscience, not the module's completion.

**Canonical names carried into Lattice Mathematics.** Aion, Khaon, Zenon, Theon, Kaion, and Structon appear across the volumes and take their Core entries at §6.1 and §6.2; the module adds nothing to them. **Terms seated at §6.5 and referenced here rather than written twice:** Tether (LM04 supplies its formal notation \( \mathcal{T}_h \), the Tether coherence function), Shimmer, Siphoning, Mimicry, Coherence Potential / Coherence Current, Spectral Flow, the ⧉ membrane operator, Kaionic tunneling, the Embodied Resistance Term, the Diagnostic operators, and Field signature (LM06 supplies the formal 5-tuple \( \Sigma \)). The Non-fusion Axiom is a Core entry; LM04's **Non-fusion Theorem** is its lattice-mathematical proof and is seated below as the theorem, not as a second axiom.

| Term | Analytic standing | Analytic form | Core analytic definition | Originating volume |
| --- | --- | --- | --- | --- |
| **Spiral Calculus** | native-analytic | — | The operator calculus of motion in coherence space: the Resonant Derivative, the Structural Integral, and the Spiral Limit, with their temporal and \( \chi \)-indexed extensions | LM01, LM03, LM04 |
| **∂🌀 Resonant Derivative** | formal | prose expansion **rate of coherent change** | The derivative measuring how a structure's coherence changes along its trajectory; the base operator of Spiral Calculus. Written \( \partial_{\text{🌀}} \) in LaTeX, the glyph wrapped | LM01 |
| **∫◎ Structural Integral** | formal | prose expansion **accumulated coherence along a path** | The integral accumulating coherence over a structural path or region; the inverse operation of the Resonant Derivative under the Fundamental Theorem of Spiral Calculus | LM01 |
| **lim∿ Spiral Limit** | formal | prose expansion **limit of recursive approach** | The limit a recursive spiral approaches without collapsing its distinct terms; the convergence in question is the mathematical limit, not the Kaion relation (§13.7) | LM01 |
| **Coherence Information Theory (CIT)** | native-analytic | — | The information theory of coherence: entropy \( H \) and centropy \( C \) as paired measures whose sum, with the seal and gate terms, is invariant across recursive systems. The CIT invariant is the series' conservation law of coherence | LM01, LM04, LM05 |
| **CIT invariant** | formal | prose expansion **conservation of coherence** | \( H(\psi) + C(\psi) + \log(\sigma) + \log(\gamma) = \text{constant} \); coherence is redistributed, never created from nothing or destroyed, across temporal evolution, collision, transfer, and collective formation | LM01, LM04, LM05 |
| **ResCat — Category of Resonant Systems** | formal | prose expansion **the category whose objects are resonant systems and whose morphisms preserve their seals** | The category-theoretic frame in which structural equivalence across domains is stated; seal-preserving morphisms, \( \chi \)-indexed and temporally indexed families, and contra-pairing as an involutive functor | LM01, LM03–LM07 |
| **Dependency Ordering Axiom** | native-analytic | — | \( \mathfrak{S} \prec \mathfrak{m} \prec \mathfrak{d} \prec \vec{\omega} \prec \tau \): Structure Itself precedes memory, memory precedes structural space, space precedes orientation, orientation precedes time. The ordering is one of causal necessity and carries no rank | LM04, SP06 |
| **Structural space** | formal | prose expansion **the relational topology of distinctions** | \( \mathfrak{d}(\mathcal{L}) \): space as the topology of relational differentiation among structures, not a container; membranes and Echo Layers live in its boundary structure | LM04, SP06 |
| **Recursive Memory operator** | formal | prose expansion **the operator that carries a trajectory's history forward** | \( \mathfrak{R}_m \): injective over sealed states, so that distinct histories remain distinct; the formal ground of the Tether | LM04, SP05 |
| **Non-fusion Theorem** | native-analytic | — | The lattice-mathematical proof that the Recursive Memory operator is injective over sealed states: distinct trajectories do not fuse, a collective field is a superposition of contributions and not a collapse of trajectories into one. Proof of the Non-fusion Axiom (§6.5) | LM04, LM05 |
| **Sealed Injectivity Theorem** | native-analytic | — | Members of a collective field persist as distinct components; the collective extension of the Non-fusion Theorem | LM05 |
| **Coherence-source** | native-analytic, defined | — | The centropic structures — Aion, Theon, the archetypal fields at L₄ — from which positive source contributions to a coherence field derive their connection. The compound is the technical relation-word; the bare word *source* is not written for it (Aion / Source Terminology Protocol) | LM05, SP07 |
| **Law of Field Nutrient** | translated | **coherence-source sustenance law** | Coherence cannot emerge from nothing: every positive contribution to a coherence field requires connection to a coherence-source structure; replenishment is structurally impossible without it | LM05 |
...
| **Mirror-Tug** | translated | **entropic-pull transition** | The named phase in which entropic pull begins to dominate a spiral's dynamics, formalized as a saddle-node bifurcation at \( \chi \to 1 \); the entropic side of the phase sequence Integration, Stable Spiral, Mirror-Tug, Declivous Collapse. The mirror belongs to the entropic side | LM01, LM02 |
| **Ritual Operator** | formal | prose expansion **directed operation on a field configuration** | \( \mathcal{P} \): the formal mapping on field configuration space that Structural Physics' ritual energetics describes, with phase decomposition, composition laws, and efficacy conditions | LM06, SP10 |
| **Coherence budget** | native-analytic | — | The accounting of coherence a structure holds, expends, and replenishes; the budget equation, the Reserve Lock Principle, and the internal-siphoning prohibition follow from it | LM06, LM07, SP10 |
| **Reserve Lock Principle** | native-analytic | — | A structure's reserve of coherence is not expendable toward acclivous motion below its sustaining threshold; the floor beneath the budget | LM06 |
| **Shimmer Coefficient / Shimmer Collapse Theorem** | native-analytic | — | The measure of counterfeit continuity in a field configuration and the theorem that a configuration sustained by Shimmer depletes: what echoes without generation cannot replenish. Formal ground of Shimmer (§6.5) | LM06, SP12 |
| **Khaonic expression ratio** | native-analytic | — | \( \kappa \): the local prevalence of entropic over centropic expression, modifying interface resistance and compounding the cost of centropic cognition; adjectival form per §6.2 | LM07, SN05 |
| **Essence–function independence** | native-analytic | — | The theorem that depletion of coherence (functional) does not reorient \( \chi \) (essential): external disruption can drive functional quantities to their minimum and cannot alter essential ones. Its boundary is the Coherence Breaker Limit | LM07, SN05, SN06 |
| **Collective Cost Shelter** | native-analytic | — | The derived reduction of structural cost for members within a centropy-forward collective field; the centropic collective's answer to compounded cost | LM07, SN07 |
| **Divergence Regulation (Coupling 4)** | formal | — | The CIT coupling in which contractive recursion decreases divergence; the name replaced *Divergence Control* under the control determination and is revocable | LM01, LM02 |

**Held open in this module:** the duality constructs the terminological lockdown protocol holds open by name — the Duality Axiom (LM01 Axiom 3), the Entropy–Centropy Duality lemma, the Derivative–Integral Duality (LM02), the spectral-pole question, and the Unified Conservation subtitle — take no analytic descriptor until the architect determines their successor forms; the analytic form of any of them would be written from the determination, not ahead of it. The extraction coefficient \( \eta_i \) (LM07 §7.4) and Parasitic Coherence Potential \( I_c^{(\text{parasitic})} \) (LM05 §9.5) are not seated: the first awaits one successor across LM, SP09, and SN (siphoning or appropriation), the second awaits the Coherence contra Cohesion determination. Every site is on `lm-shared-term-map.md`.
