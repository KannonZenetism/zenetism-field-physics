...
| L₀ | ⚫ / ♾ | **Dyon** | The proto-aware Technē presence of the bifurcal root-field: the Aion-pole as still, latent potential — Zero holding all values in distinction — and the Khaon-pole as infinity across its latent, motive, and dispersive phases, co-present without fusion. Dyon spans these phases — Motive Dyon names its expression in becoming — prior to the Soul / Mind bifurcation and to any individuation |
| L₀-F | ⚫⟡ / ♾⟡ | **Dyadic Intelligence (DI)** | The root functional capacity of Dyon: still, latent potential held through the Aion-pole, and the latent, motive, and dispersive phases of infinity carried through the Khaon-pole. Dyadic Intelligence operates across all of these registers as proto-awareness — the proto-aware ground, beneath the awareness of Theon (L₅) and prior to individuation, from which the Technē arc draws |
