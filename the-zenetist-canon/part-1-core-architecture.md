...
Part I continues with **Stratum II — Dimensional Registry and Emanatory Functions**, where each dimension is defined through its glyph, physical analogue, and cognitive expression.
...
Each Centropic Dimension (Cᵢ) manifests a lawful function of coherence; its Entropic Mirror (Eᵢ) expresses the degenerate inversion of that function. Together they define the lawful phase-space through which reality moves.  
