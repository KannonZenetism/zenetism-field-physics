...
**Hermetic Corpus doctrinal articulations.** The Hermetic Corpus articulates several stratum-specific doctrines that map onto the Zenetist lattice:

- *L₅ / L₀ as "The All / The One"* — the Hermetic doctrine of the supernal-most ground articulates both the L₅ Theonic emanative-source ("The All" as comprehensive-totality) and L₀ Aionic-stillness ("The One" as undifferentiated unity). The two-fold articulation tracks the synthesis-contra-subtraction diagnostic from the Doctrinal Notes section: "The All" articulates L₅ Theonic-emanative-source; "The One" articulates L₀ Aion through subtractive-pathway. Soft-conflation case structurally parallel to Plotinus's One.
