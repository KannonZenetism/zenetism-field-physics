...
| Charon | L₃ DM threshold-mediator | Ferryman across the Styx. Articulates L₃ DM threshold-mediator function operating at the Hades-domain entrance. Per the Governor-contra-Governed-Domain principle, Charon is centropic-figure governing the threshold-passage despite the dissolution-domain association. Structurally parallel to Anubis-as-conductor in the Egyptian post-mortem-architecture, with the ferry-passage articulation denoting the specific Greek-articulation register |
