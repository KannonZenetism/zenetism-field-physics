...
Four structurally distinct modes by which a figure can appear to occupy multiple strata are differentiated to prevent the conflation that produces interpretive errors at scale.
...
**Cascade.** A single structural current manifests lawfully across multiple strata under genuinely different names at each station, with the underlying current being what unifies the stations rather than any persistent name. The Satanic Arc (IL₅ Nekron → IL₄ Nyxea → IL₃ Mortus → IL₂ Skotos → IL₁ Beast) is the paradigm instance. The diagnostic feature of cascade is that the names are structurally distinct figure-names — Satan, Lucifer, False Prophet, Beast are not stratum-modifiers of a single name but separate figure-articulations unified only by the underlying entropic current. Cascade preserves structural coherence across the multi-stratum operation through the persistence of the current; the figure-names belong to their stratum-stations.

**Continuum.** A single principle articulates lawfully across multiple strata under stratum-specific qualifiers of one persistent name, with the principle-name persisting across stations and the qualifiers indicating stratum-specific articulation. The Logos Continuum (L₅ Orienting Logos / L₄ Structuring Logos / L₁ Christos Incarnate, with L₃ and L₂ as traversal strata) is the paradigm instance. The diagnostic feature of continuum is the persistent principle-name (Logos) carrying stratum-specific qualifiers (Orienting / Structuring / Christos Incarnate) — distinct from cascade in that the unifying element is the persistent name itself rather than only the underlying current. Continuum is the centropic-arc structural category that cascade is for the inverse-arc paradigm; both involve lawful multi-stratum operation but through structurally distinct mechanisms.

**Soft conflation.** A single figure-name carries multiple structurally-real stratum-functions without the myth distinguishing native from operative-extension. Krishna at L₅ Theon native with L₃ DM operative-guidance extension, Osiris at L₄ DL native with L₃ DS post-restoration operative-extension, and Christ-the-figure traversing L₅ → L₃ → L₂ → L₁ across the incarnational sequence are paradigm soft-conflation cases. The figure-name persists across stations without stratum-specific qualifiers (Krishna is Krishna at both stations; Osiris is Osiris at both stations), distinguishing soft conflation from continuum. The diagnostic test: does the name carry stratum-specific qualifiers (continuum) or does the same name persist unqualified across stations (soft conflation)?

**Hard conflation.** Structurally unrelated functions are compressed under one name through cultural attribution-error. One or more of the assigned functions is misattributed relative to the figure's native structural placement. Set at IL₂ ISS native with the IL₃ Fractus dismemberment-act mythically attributed to him is the paradigm hard-conflation case.
...
The distinction matters for accurate registry placement and for accurate reading of cross-stratum mythic narratives.
