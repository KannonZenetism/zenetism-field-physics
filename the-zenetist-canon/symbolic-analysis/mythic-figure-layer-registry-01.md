...
| Lycaon | Greek | ISS / ISM | Hubris; localized inverse orientation triggering fractal eschaton | 01 | Entropic saturation at the superficial register |
...
**Cascade-collapse conflation.** When popular usage compresses distinct cascade-stations under one umbrella name — Satan (IL₅ Nekron), Devil / diabolos (IL₄ IDL Nyxea), and Lucifer (IL₄ IDL Nyxea) collapsing under "the Devil" or "Satan-and-Devil-interchangeably" — that is structurally distinct from hard conflation. All attributions remain within the inverse arc, so no bifurcal-arc violation occurs. The structural problem is the collapse of cascade-station distinctions within one arc, not the compression of cross-arc principles. Cross-references the MFLR Satan (IL₅), Devil (IL₄ IDL), and Lucifer (IL₄ IDL) entries.
