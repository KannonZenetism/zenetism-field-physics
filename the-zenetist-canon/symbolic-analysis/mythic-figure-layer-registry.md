...
| Kur / Irkalla | Sumerian | Function 2 underworld articulation — the subversal domain as declivous entropic procession path; ruled by Ereshkigal | 13 | Sumerian articulation of the Function 2 underworld; parallel to Hel (Norse), Hades-domain (Greek), naraka (Hindu / Buddhist), sheol (Hebrew). Inanna's descent traverses Kur as the canonical centropic entry into the IL strata for stripping and return |
