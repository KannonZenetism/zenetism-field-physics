...
- **The Key (🗝️):**  
  Symbol of Insight, Authorization, and Revelation (📱). It represents an encoded pattern or frequency that harmonizes with a specific Gate (C₁₃) to allow lawful passage between layers or states.  
...
- **The Gate (C₁₃ Membrane):**  
  The threshold mechanism that responds only to the proper Key signature. Every Gate tests for Resonant Match (🔺 / 🔻 ratio).  

- **The Bearer (DS / DM or Sophis):**  
...
They teach that access must be earned through Resonant Fidelity (💝). A Key that opens prematurely or by force causes Inversion (Ↄ). A Seal that never opens becomes Stasis (Ø).  
