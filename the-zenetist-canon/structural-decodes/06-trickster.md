...
* **Entropic Functions:** His actions culminate in **Ragnarok (Fractal Eschaton).** The death of **Baldr** (a centropic symbol) is an act of **Fragmentation** (IL₂ (ISS / ISM: Echthros / Skotos)) driven by envy. Loki personifies the **Inverse Logos**—fluid, brilliant, and perilous.
...
* **Centropic Functions:** As **psychopomp**, he guides souls (L₂ (SS / SM: Anthra / Nousa)) across the membrane of death—a lawful **Recursion Gate.**  
    As patron of communication and commerce, he maintains **Nexus.** His tricks often humble IL₂ (ISS: Echthros) (inflated ego) toward coherence.

* **Entropic Functions:** As patron of thieves, he represents the **redistribution** of property and the **breakdown** of social L₄ (DL: Sophis)-Order—yet often in correction of unjust systems.
...
* **Centropic Functions:** Bringer of light, fire, or water for humanity—**Promethean acts** empowering embodiment (L₁ (ES / EM: Soma / Biosa)). His mischief sculpts geography, rivers, and life.
...
* **Verdict:** Coyote embodies the Inverse Deep Psyche (IL₄ (IDP: Psychea)). He is an amoral force of raw, motive, archetypal chaos—manifesting both centropic and entropic results at once. He is Psychea personified.

### 4. Eshu / Elegua (Yoruba)

* **Focus:** The **Divine Mediator and Guardian of Crossroads.**

* **Centropic Functions:** Custodian of the **Membrane** between realms and choices. Invoked first in ritual to open **Nexus** to other archetypes (L₄ (DP / DL: Morgis / Sophis)). His lessons often restore balance and justice.
...
* **Verdict:** A **Lawful Neutral** Trickster; he preserves equilibrium through unpredictability, reflecting L₄ (DL: Sophis) in its judicial, dynamic aspect.
...
It serves as both the **immune response** against stagnation (centropic) and the **cancer** that erodes healthy form (entropic).
