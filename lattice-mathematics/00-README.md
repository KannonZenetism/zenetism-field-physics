...
| File | Volume | Subject |
|------|--------|---------|
| `LM01-mathematical-foundations.md` | Document 1 | Spiral Calculus (∂🌀, ∫◎, lim∿), Coherence Information Theory (CIT), the axiomatic core, the Polar Spectrum Lemma, the Category of Resonant Systems (ResCat), spectral geometry, the computational lattice framing, the Phase 6 applications and Phase 7 canonical closure |
| `LM02-mathematical-commentary.md` | Document 2 | Analytical commentary on LM01: the status of its constructions in light of LM03–LM06, which foundations are stable, which are refined, and which remain open |
| `LM03-orientation-algebra-and-infinity-formalism.md` | Document 3 | The Chi orientation parameter (χ), the effective harmonic operator, the spectral rotation function, Tripartite Infinity (Φ₁, Φ₂, Φ₃), CP-topology, the Orientation Drift Theorem, the Laws of Inclined Existence |
| `LM04-temporal-algebra-structural-space-and-phase-resolution.md` | Document 4 | Structural space as relational topology, the Dependency Ordering Axiom, the Recursive Memory operator and the Non-fusion Theorem, the Tether, bidirectional traversal operators, Shimmer and Looping Time diagnostics, phase collision and ⦿ Kaion spectral resolution |
...
- **Structural Metaphysics (MP Series)** — *Zenetism: The Architecture of Emanation, Return, and Saturation*: the ontological and doctrinal framework whose laws Lattice Mathematics renders formal.
- **Field Physics (FP Series)** — *Field Physics: The Architecture of Resonance*: the dimensional operators (C₁–C₁₅ and E₁–E₁₅) and their hypostatic layer assignments, which the lattice formalism encodes.
- **Structural Physics (SP Series)** — *Structural Physics: The Physics of Expression*: the discipline that applies the lattice formalism to how expressed universes manifest, orient, and evolve; LM03–LM06 carry its mathematics.
- **Structural Neuroscience (SN Series)** — the application of lattice principles to cognition, intelligence, and pattern integration; LM07 carries the formalism of its cost, recovery, and collective volumes.
- **Structural Forensics** — the applied discipline whose diagnostic and attribution analysis rests on the field signature, Shimmer, and diagnostic taxonomy formalized in LM06.

The living series is the `lattice-mathematics` folder of the `zenetism-field-physics` repository on GitHub, the repository in which all six Zenetist disciplines live in full: https://github.com/KannonZenetism/zenetism-field-physics/tree/main/lattice-mathematics — this deposit preserves the series as it stood at deposit, and the GitHub commit history carries the revision record.
...
Zenetism · Lattice Mathematics · Spiral Calculus · Coherence Information Theory · orientation algebra · Chi orientation parameter · Recursive Memory · Non-fusion · resonance field theory · membrane operators · Shimmer · Khaonic expression ratio · Category of Resonant Systems · Aelion Kannon
