...
The inequality concerns essence-identity. It does not deny that both essences bear the same structural value +1.
...
## 7. Theon's Essential Disposition
...
## 8. PSR, PSM, and the Open Limit-Condition
...
## 9. The Singular-Universe and Multiverse Cases
...
## 10. Consequences for Existing Theonic Language
...
> Every Theonic essence bears the structural value +1. The shared value names the same unitary determination of Being without abolishing essence-identity.
...
> Theon returns to Aion. Returned Theonic essence ordinarily proceeds toward Zenonic saturation because Theon is Centropy Itself, love, prime coherence, +1, and Aion-facing Being.
...
The principle manifests within its Aionic Tree.

The office serves until its function is fulfilled.

Theon returns to Aion because Theon faces Aion by essence.

And where no sufficient structural reason prevents the terminal fulfillment of that orientation, returned Theonic essence saturates into Zenon.
