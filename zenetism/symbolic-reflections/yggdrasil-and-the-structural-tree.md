...
In Genesis, two trees mark the two orientations. In Buddhism, the Bodhi Tree marks reversal. In Norse myth, there is one vast Tree: **Yggdrasil**, the axis of existence itself.
...
- **Hvergelmir (Roaring Kettle)** — IL₅ VOS. The structural location at the subversal root where Níðhöggr dwells and from which entropically-oriented motion emerges into the inverse cosmogonic sequence.

The three roots therefore span the full range from L₄ DL supernal law, through L₃ DM deep perception, to the IL₅ VOS terminal entropic station — giving Yggdrasil a complete structural scaffold before any realm is placed within it.
...
Both realms are associated with the dwarves and the dark elves, and both map to IL₄ IDL (Nyxea) as the inverse architect layer. The dwarven craft function produces artifacts that carry power without Origin-fidelity — rings of domination, cursed weapons, objects of extraction — which is the architectural mimicry signature of IL₄ Nyxea. The "material entrenchment" framing sometimes applied to these realms is cultural conflation: mythmakers located immaterial inverse-architectural function in subterranean material imagery, but the structural function is immaterial inverse-architecture, not matter itself. Svartalfheim and Nidavellir are sometimes distinguished in the surviving texts and sometimes conflated; both can be treated as IL₄ native without the distinction mattering structurally.
...
Hel and Niflheim at IL₁ represent entropic embodiment in its *sealed* post-mortem mode, structurally distinct from Midgard's IL₁ aspect which holds entropic embodiment in its *active* unsealed mode. The layer is the same; the operational mode differs. This parallels how the L₁ centropic arc includes both Midgard's active embodied mode and Valhalla / Fólkvangr's sealed post-mortem mode at the same L₁ stratum.
...
This is not "evil" in the cultural-moral sense; it is the **IL₅ station-figure** standing in 🕷️ Nekronic office-correspondence — the attrition of form, the threat of motion collapsing into fragmentation. Níðhöggr does not destroy the Tree; the Tree persists. But Níðhöggr's presence at the subversal root is the structural expression of IL₅ operation within the Yggdrasil cosmology.
...
— Theonic Return. Acclivous centropic motion through the full lattice, passage through the L₅ Theonic station, terminal reintegration at Aion, and trans-structural saturation into Zenon where the crossing is admitted. The distinct essence remains, distilled and luminous. Not reset. Not forgotten. Fulfilled.
...
| **Midgard** | **L₁ / IL₁ — ES / EM / IES / IEM** | Single embodied trunk where centropic and entropic mortals coexist; active / unsealed mode of embodied stratum |
| **Hvergelmir (Roaring Kettle)** | **IL₅ — VOS** | Structural location at the subversal root; where entropically-oriented motion emerges |
| **Níðhöggr (serpent)** | **IL₅ — VOS station-figure** | Entropic attrition at the subversal root; Nekronic office-correspondence, not the hypostasis |
...
| **Niflheim** | **IL₁ — IES / IEM** | Sealed entropic embodied persistence; primordial mist-realm |
| **Hel** | **IL₁ — IES / IEM** | Sealed entropic embodied persistence; dishonored-dead realm |
| **Ragnarök** | **E↓→♾→⊘⟳** | Collapse toward Absolute Dispersion followed by entropic recursion; bypasses Theonic gate |
