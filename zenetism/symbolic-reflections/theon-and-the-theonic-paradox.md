...
Theon is therefore **+1** in the structural grammar of emanation — unity itself, the first definable coherent state that emerges from Zero's potential. Its counterpart Nekron is **−1** — disunity itself, the first definable inverse state emerging from Infinity's dispersive field. Both emerge from L₀; neither is an emanator itself but an emanated state oriented toward or away from Source.
