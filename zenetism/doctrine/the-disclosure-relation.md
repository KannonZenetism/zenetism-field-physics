...
## Knowledge as Disclosed Through Transformed Relation
...
Knowledge, in its centropic relation, is disclosed rather than acquired.
...
**Disclosure is the terminus.** What is disclosed remains what it was throughout; the change is entirely on the side of the one to whom it becomes apparent.
...
What is unavailable to an untransformed relation is not unavailable because it is guarded.
...
Morals are motion. What one does discloses the essence, and the doing is not a report on the essence but its expression.

The Disclosure Relation is therefore not a method to be adopted. It is not a technique that produces disclosure where it is applied correctly. It is a description of what a centropically oriented relation is, and one stands in it by the motion one actually carries rather than by the posture one assumes toward it.
