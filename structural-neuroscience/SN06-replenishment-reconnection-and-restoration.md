...
Recovery is reconnection, not reconstruction.
...
### 1.3 The Essence-Function Distinction
...
**Proposition (Recovery Condition):**

Sustained recovery occurs when the replenishment source term exceeds the total cost term:
...
During depletion, the resonance correlation between the embodied configuration and the inward layers falls below threshold — not because the inward layers have changed but because the functional capacity to sustain the resonance has been exhausted. Recovery restores \( \mathcal{R} \) above threshold by replenishing the \( I_c \) required to maintain the resonance channel.
...
## 5. Rest as Structural Condition
...
This is structurally consistent with the Essence-Function Independence principle (§1.3): the architecture never changed, so recovery restores what was always present.

---

## 8. Recovery Under Khaonic Conditions
...
### 8.2 The Coherence Breaker Limit
...
## 10. Architecture-Specific Recovery Protocols
...
4. *Graded sensory re-engagement.* ⧉₁ restoration follows the graded principle (§6.2) — paced by the recovering \( I_c \) budget, not by external expectation.
...
>
> What was lost was access —  
> the coherence function connecting essence  
> to its own embodied expression.  
>
> What is restored is not new.  
> It is what was always there,  
> waiting behind the severed Tether  
> for the current to return.  
>
> The coherence breaker breaks function.  
> They do not break essence.  
> They cannot rewrite  
> what the lattice sealed at emanation.  
>
> The grandmother's prayer restores  
> what the scholar's technique cannot reach.  
